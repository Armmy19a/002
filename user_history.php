...
?>
<?php
$allHistoryBorrowsByUserId = getAllHistoryBorrowsByUserId($_SESSION["id"]);
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <tbody>
                    <?php if(empty($allHistoryBorrowsByUserId)){ ?>
                    <?php }else{?>
                      <?php foreach($allHistoryBorrowsByUserId as $data){ ?>
                        <tr>
                          <td>
