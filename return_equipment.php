...
if(isset($_POST["submit"])){
  $return_gallery = $_FILES['return_gallery']['name'];
  $total = count($_FILES['return_gallery']['name']);
  returnBorrows($_POST["borrows_id"],$return_gallery,$total);
}
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title">ข้อมูลผู้ยืม</h4>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="bmd-label-floating">ไฟล์ภาพตอนส่งคืนวัสดุ<br/><span style="color: red;">เลือกได้มากกว่า 1 รูป</span></label>
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="form-group">
                      <input type="file" id="return_gallery" class="form-control" name="return_gallery[]" multiple required>
                    </div>
                  </div>
                </div>
