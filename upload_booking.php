...
if(isset($_POST["submit"])){
  ...
  uploadBorrowImage($_POST["borrows_id"],$borrow_gallery,$total);
}
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="bmd-label-floating">อัพโหลดรูปวัสดุ<br/><span style="color: red;">เลือกได้มากกว่า 1 รูป</span></label>
                    </div>
                  </div>
                  <div class="col-md-8">
                    <div class="form-group">
                      <input type="file" id="borrow_gallery" class="form-control" name="borrow_gallery[]" multiple required>
                    </div>
                  </div>
                </div>
